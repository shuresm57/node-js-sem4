...
<div class="min-h-screen bg-bg flex flex-col items-center justify-center px-4">
    <h1 class="font-serif text-accent mb-8 text-8xl font-bold tracking-tight">BetterTour</h1>
        ...
        {#if view === 'login'}
            ...
            <div class="flex flex-col gap-3">
                <input
                    ...
                    type="text" placeholder="Username" bind:value={usernameInput} required
                >
                <input
                    class="bg-bg border border-border text-text placeholder-muted rounded-lg px-4 py-4 focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <button
                ...
                type="button" onclick={() => handleLogin(usernameInput, passwordInput)}
            >Login</button>
